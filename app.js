// --- CONFIGURATION ---
        const FACES = {
            1: { id: 1, nums: [1, 6, 10, 15, 24, 29, 33, 34], color: '#06b6d4', bg: 'rgba(6, 182, 212, 0.15)', border: '#0891b2' }, // Cyan
